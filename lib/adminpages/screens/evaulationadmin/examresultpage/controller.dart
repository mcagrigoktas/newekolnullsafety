...
class ExamResultViewController extends GetxController {
  ...
  final ExamResultBigData examResultBigData;
  Map<String?, Map<String?, ResultModel?>?>? get allKurumAllStudentResults => examResultBigData.examResult;
  ExamResultViewController({required this.examResultBigData, required this.girisTuru, required this.examType, required this.exam});
