...
//
// class ClassHoursDetail extends StatefulWidget {
//   final int sayfaTuru;
//   final String islemYapilacakKey;
//   final GlobalKey<FormState> formKey;
//   final Function resetPage;
//   ClassHoursDetail({this.islemYapilacakKey, this.sayfaTuru, this.formKey, this.resetPage});
//
//   @override
//   ClassHoursDetailState createState() {
//     return ClassHoursDetailState();
//   }
// }
//
// // TeacherType 1: Sınıf 2. Branş
// class ClassHoursDetailState extends State<ClassHoursDetail> with SingleTickerProviderStateMixin {
//   Map _data;
...
//       GetDataService.dbGetClassActiveTimes(widget.islemYapilacakKey).once().then((snap) {
//         setState(() {
//           _data = snap.value;
...
//       isLoading = true;
//     });
//     SetDataService.saveClassActiveTimes(_data, widget.islemYapilacakKey).then((a) {
//       widget.resetPage();
//       OverAlert.saveSuc();
//     }).catchError((error) {
//       setState(() {
