...
//
// class ClassHoursList extends StatefulWidget {
//   final int sayfaTuru;
//   final String islemYapilacakKey;
//   final Function onTap;
//
//   ClassHoursList({this.sayfaTuru, this.islemYapilacakKey, this.onTap});
//
//   @override
//   ClassHoursListState createState() {
//     return ClassHoursListState();
//   }
// }
//
// class ClassHoursListState extends State<ClassHoursList> {
//   String filterText = "";
//
...
//     final List<Class> filteredList = AppVar.appBloc.classService.dataList.where((sinif) => sinif.getSearchText.contains(filterText ?? "")).toList();
//
