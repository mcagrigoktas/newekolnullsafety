...
class Contracts extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ContractsController>(
        ...
        builder: (controller) {
          final Widget _newButton = controller.selectedPerson != null
              ? MyOutlinedButton(
          ...
          final _topBar = controller.newContract != null
              ...
              : RTopBar(
                  ...
                  detailLeadingTitle: 'contracts'.translate,
          ...
          if (controller.isPageLoading) {
            ...
            _leftBody = controller.newContract != null
                ...
                : Body.listviewBuilder(
                    pageStorageKey: AppVar.appBloc.hesapBilgileri.kurumID + 'contractList',
                      ...
                      children: [
                        ...
                        AdvanceDropdown<String>(
                            items: [
                              ...
                              DropdownItem(value: 'other', name: 'other'.translate),
                            ],
                    ...
                    itemCount: controller.filteredPersonList.length,
                    itemBuilder: (context, index) => MyCupertinoListTile(
                      title: controller.filteredPersonList[index].name,
                      onTap: () {
                        controller.selectPerson(controller.filteredPersonList[index]);
                      },
                      isSelected: controller.filteredPersonList[index].key == controller.selectedPerson?.key,
                      imgUrl: controller.filteredPersonList[index].imgUrl,
                    ),
                  );

            _rightBody = controller.selectedPerson == null
                ? Body.child(child: EmptyState(emptyStateWidget: EmptyStateWidget.CHOOSELIST))
                : controller.newContract == null && controller.contractListOfSelectedPerson.isEmpty
                    ? Body.child(child: EmptyState(emptyStateWidget: EmptyStateWidget.NORECORDSWITHPLUS))
